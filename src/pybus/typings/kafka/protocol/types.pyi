...
class Array(AbstractType):
    ...
    def decode(self, data) -> list[Any | tuple[Any, ...] | None] | None:
        ...
...
class BitField(AbstractType):
    @classmethod
    def decode(cls, data) -> set[Any]:
        ...
    
    @classmethod
    def encode(cls, vals) -> bytes:
        ...
    
    @classmethod
    def to_32_bit_field(cls, vals) -> Literal[0]:
        ...
    
    @classmethod
    def from_32_bit_field(cls, value) -> set[Any]:
        ...
