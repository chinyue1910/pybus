...
class KafkaConsumer(six.Iterator):
    ...
    def close(self, autocommit=..., timeout_ms=...) -> None:
    ...
    def commit(self, offsets=..., timeout_ms=...) -> None:
    ...
    def committed(self, partition, metadata=..., timeout_ms=...) -> None:
    ...
    def partitions_for_topic(self, topic) -> set[Any]:
    ...
    def poll(self, timeout_ms=..., max_records=..., update_offsets=...) -> dict[Any, Any] | dict[Any, list[Any]]:
    ...
    def offsets_for_times(self, timestamps) -> dict[Any, Any]:
    ...
    def beginning_offsets(self, partitions) -> dict[Any, Any]:
    ...
    def end_offsets(self, partitions) -> dict[Any, Any]:
