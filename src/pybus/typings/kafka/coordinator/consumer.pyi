...
class ConsumerCoordinator(BaseCoordinator):
    ...
    def refresh_committed_offsets_if_needed(self, timeout_ms=...) -> bool:
        """Fetch committed offsets for assigned partitions."""
        ...
    
    def fetch_committed_offsets(self, partitions, timeout_ms=...) -> dict[Any, Any] | None:
